...
class JSONFactory {
public:
    static ptr< Node > createNodeFromTestJsonFile( const string& _sgxUrl, const fs_path& jsonFile,
    ...
    static ptr< Node > createNodeFromJsonObject( const nlohmann::json& _j, set< node_id >& nodeIDs,
        ConsensusEngine* _engine, bool _useSGX, const string& _sgxURL,
        const string& _sgxSSLKeyFileFullPath, const string& _sgxSSLCertFileFullPath,
        const string& _ecdsaKeyName, const ptr< vector< string > >& _ecdsaPublicKeys,
        const string& _blsKeyName, const ptr< vector< ptr< vector< string > > > >& _blsPublicKeys,
    ...
    static pair< ptr< vector< string > >, ptr< vector< string > > > parseAllTestKeyNames(
        string& _sgxServerUrl, const fs_path& _dir );
