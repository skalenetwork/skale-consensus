...
public:
    ...
    static uint64_t getBLSStats() { return blsSignTotal / LEVELDB_STATS_HISTORY; }

    static uint64_t getECDSAs() { return ecdsaCounter; }

    static uint64_t getBLSs() { return blsCounter; }

    static uint64_t getECDSATotals() { return ecdsaCounter; }

    static uint64_t getBLSTotals() { return blsCounter; }
