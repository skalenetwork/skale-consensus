/*
    ...
    @file ConsensusBLSPublicKey.cpp
    @author Stan Kladko
    @date 2019
*/
...
#include "ConsensusBLSPublicKey.h"

ConsensusBLSPublicKey::ConsensusBLSPublicKey(
    const string& k1, const string& k2, const string& k3, const string& k4, node_count _nodeCount )
    : BLSPublicKey(k1, k2, k3, k4, (size_t) _nodeCount, (size_t)_nodeCount) {
