...
class Node {
    ...
    /**
     * Stores random values for each block that are generated by merging an additional set of signatures not stored in block proposal.
     * They are used as source of deterministic randomness, and kept offchain to only allow participating nodes
     * to have access to this random.
     */
    ptr< ReencryptionRandomDB > reencryptionRandomDB;
...
public:
    ...
    ptr< ReencryptionRandomDB > getReencryptionRandomDB() const;
#endif
#endif
