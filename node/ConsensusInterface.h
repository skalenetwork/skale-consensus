...
constexpr uint64_t BITE_MAGIC_SIZE = 20;
constexpr std::string_view BITE_MAGIC_AS_STRING = "42495445204D452049274D20454E435259505444";
constexpr uint8_t BITE_MAGIC_AS_BYTE_ARRAY[BITE_MAGIC_SIZE] = {0x42, 0x49, 0x54, 0x45, 0x20, 0x4D, 0x45, 0x20,
