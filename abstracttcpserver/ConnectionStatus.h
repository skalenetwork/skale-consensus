...
enum ConnectionSubStatus {
    ...
    CONNECTION_ERROR_CANT_PARSE_PROPOSAL_TRANSACTION = 30,
    CONNECTION_ERROR_CANT_VERIFY_PROPOSAL_TRANSACTION = 31,
    CONNECTION_ERROR_INVALID_AES_KEY_ENCRYPTION_IN_PROPOSAL_TRANSACTION = 32,
    CONNECTION_ERROR_CANT_PROCESS_PROPOSAL_TRANSACTIONS = 33,
    CONNECTION_ERROR_CANT_STORE_PROPOSAL_TRANSACTIONS = 34,
    CONNECTION_ERROR_BLOCK_INCLUDES_INVALID_ENCRYPTIONS = 35,
    CONNECTION_FINALIZE_DONT_HAVE_DECRYPTION_SHARES = 36,
    CONNECTION_ERROR_INVALID_EPOCH_ID = 37
#endif
