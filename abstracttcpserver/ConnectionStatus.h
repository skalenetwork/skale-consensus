...
enum ConnectionSubStatus {
    ...
    CONNECTION_ERROR_CANT_PARSE_PROPOSAL_TRANSACTIONS = 30,
    CONNECTION_ERROR_CANT_VERIFY_PROPOSAL_TRANSACTIONS = 31,
    CONNECTION_ERROR_CANT_DECRYPT_PROPOSAL_TRANSACTIONS = 32,
