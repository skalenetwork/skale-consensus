...
enum ConnectionSubStatus {
    ...
    CONNECTION_ERROR_UNKNOWN_SCHAIN_ID = 2, CONNECTION_ERROR_UNKNOWN_SERVER_ERROR = 3,
    CONNECTION_ERROR_DONT_KNOW_THIS_NODE = 4, CONNECTION_ERROR_INVALID_NODE_INDEX = 5,
    CONNECTION_ERROR_INVALID_NODE_ID = 6, CONNECTION_ERROR_TIME_STAMP_IN_THE_FUTURE = 7,
    ...
    CONNECTION_DA_PROOF_IN_THE_FUTURE = 28,
    CONNECTION_DID_NOT_CREATE_OWN_PROPOSAL_YET = 29,
    };