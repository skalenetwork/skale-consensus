...
EcdsaProposerSignature is a signature of the proposal using the ECDSA private key of the node that made the proposal $$ EcdsaProposerSignature = EcdsaSign(ProposerNodeEcdsaKey, Proposal) $$.
