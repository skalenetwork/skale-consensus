...
#ifndef FLATBUFFERS_GENERATED_COMMONSTRUCTURES_SKALE_FB_H_
#define FLATBUFFERS_GENERATED_COMMONSTRUCTURES_SKALE_FB_H_
...
struct BlockHeaderT : public ::flatbuffers::NativeTable {
  ...
  std::unique_ptr<skale_fb::Hash> transactions_merkle_root{};
  std::unique_ptr<skale_fb::Hash> parent_hash{};
...
struct BlockHeader FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const skale_fb::Hash *transactions_merkle_root() const {
    return GetStruct<const skale_fb::Hash *>(VT_TRANSACTIONS_MERKLE_ROOT);
  }
  const skale_fb::Hash *parent_hash() const {
    return GetStruct<const skale_fb::Hash *>(VT_PARENT_HASH);
  }
  const skale_fb::ExtraData *extra_data() const {
    return GetStruct<const skale_fb::ExtraData *>(VT_EXTRA_DATA);
  }
  const ::flatbuffers::Vector<const skale_fb::Hash *> *committee_hash() const {
    return GetPointer<const ::flatbuffers::Vector<const skale_fb::Hash *> *>(VT_COMMITTEE_HASH);
  }
...
struct BlockHeaderBuilder {
  ...
  void add_transactions_merkle_root(const skale_fb::Hash *transactions_merkle_root) {
    fbb_.AddStruct(BlockHeader::VT_TRANSACTIONS_MERKLE_ROOT, transactions_merkle_root);
  }
  void add_parent_hash(const skale_fb::Hash *parent_hash) {
    fbb_.AddStruct(BlockHeader::VT_PARENT_HASH, parent_hash);
  }
  void add_extra_data(const skale_fb::ExtraData *extra_data) {
    fbb_.AddStruct(BlockHeader::VT_EXTRA_DATA, extra_data);
  }
  void add_committee_hash(::flatbuffers::Offset<::flatbuffers::Vector<const skale_fb::Hash *>> committee_hash) {
...
inline ::flatbuffers::Offset<BlockHeader> CreateBlockHeader(
    ...
    uint64_t time_stamp_s = 0,
    uint64_t time_stamp_ms = 0,
    const skale_fb::Hash *transactions_merkle_root = nullptr,
    const skale_fb::Hash *parent_hash = nullptr,
...
struct BlockFragmentT : public ::flatbuffers::NativeTable {
  ...
  uint16_t index = 0;
  std::vector<skale_fb::TruncatedHash> tx_truncated_hashes{};
...
struct BlockFragment FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<const skale_fb::TruncatedHash *> *tx_truncated_hashes() const {
    return GetPointer<const ::flatbuffers::Vector<const skale_fb::TruncatedHash *> *>(VT_TX_TRUNCATED_HASHES);
  }
...
struct BlockFragmentBuilder {
  ...
  void add_tx_truncated_hashes(::flatbuffers::Offset<::flatbuffers::Vector<const skale_fb::TruncatedHash *>> tx_truncated_hashes) {
...
inline ::flatbuffers::Offset<BlockFragment> CreateBlockFragment(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    uint16_t index = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<const skale_fb::TruncatedHash *>> tx_truncated_hashes = 0,
...
inline ::flatbuffers::Offset<BlockFragment> CreateBlockFragmentDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    uint16_t index = 0,
    const std::vector<skale_fb::TruncatedHash> *tx_truncated_hashes = nullptr,
    const std::vector<skale_fb::Hash> *left_proof = nullptr,
    const std::vector<skale_fb::Hash> *right_proof = nullptr) {
  auto tx_truncated_hashes__ = tx_truncated_hashes ? _fbb.CreateVectorOfStructs<skale_fb::TruncatedHash>(*tx_truncated_hashes) : 0;
...
inline BlockHeaderT::BlockHeaderT(const BlockHeaderT &o)
      : schain_id(o.schain_id),
        ...
        transactions_merkle_root((o.transactions_merkle_root) ? new skale_fb::Hash(*o.transactions_merkle_root) : nullptr),
        parent_hash((o.parent_hash) ? new skale_fb::Hash(*o.parent_hash) : nullptr),
        extra_data((o.extra_data) ? new skale_fb::ExtraData(*o.extra_data) : nullptr),
...
inline void BlockHeader::UnPackTo(BlockHeaderT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = transactions_merkle_root(); if (_e) _o->transactions_merkle_root = std::unique_ptr<skale_fb::Hash>(new skale_fb::Hash(*_e)); }
  { auto _e = parent_hash(); if (_e) _o->parent_hash = std::unique_ptr<skale_fb::Hash>(new skale_fb::Hash(*_e)); }
  { auto _e = extra_data(); if (_e) _o->extra_data = std::unique_ptr<skale_fb::ExtraData>(new skale_fb::ExtraData(*_e)); }
...
#endif  // FLATBUFFERS_GENERATED_COMMONSTRUCTURES_SKALE_FB_H_
