...
BVBroadcastMessage::BVBroadcastMessage( block_id _blockID,
#ifdef BITE
    epoch_id _epochID,
#endif
    ...
    : NetworkMessage( MSG_BVB_BROADCAST, _blockID,
#ifdef BITE
    _epochID,
#endif
    _blockProposerIndex, r, value, _timeMs,
...
BVBroadcastMessage::BVBroadcastMessage( node_id _srcNodeID, block_id _blockID,
    ...
    : NetworkMessage( MSG_BVB_BROADCAST, _srcNodeID, _blockID,
#ifdef BITE
    _epochID,
#endif
