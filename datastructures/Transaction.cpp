...
ptr< BiteDataField > Transaction::tryGetBiteData(u256 _currentEpochId, bool _doRealCrypto) const {
    ...
    if (tx->hasToField()) {
        ...
        result = BiteDataField::createIfMagicMatches(dataField, to, _currentEpochId, _doRealCrypto);
    }
