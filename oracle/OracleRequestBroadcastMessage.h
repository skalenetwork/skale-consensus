...
public:
    OracleRequestBroadcastMessage( block_id _blockID, schain_index _blockProposerIndex, bin_consensus_round r,
                        bin_consensus_value value, uint64_t _timeMs, BinConsensusInstance& sourceProtocolInstance );

    OracleRequestBroadcastMessage( node_id _srcNodeID, block_id _blockID, schain_index _blockProposerIndex,
