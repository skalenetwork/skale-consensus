...
public:
    HistoryDecideMessage( bin_consensus_round _r, bin_consensus_value _value,
        BinConsensusInstance& _srcProtocolInstance );
};
...
public:
    HistoryBVSelfVoteMessage( bin_consensus_round _r, bin_consensus_value _value,
        BinConsensusInstance& _srcProtocolInstance );
};
...
public:
    HistoryAUXSelfVoteMessage( bin_consensus_round _r, bin_consensus_value _value,
        BinConsensusInstance& _srcProtocolInstance );
};
...
public:
    HistoryCommonCoinMessage( bin_consensus_round _r, bin_consensus_value _value,
        BinConsensusInstance& _srcProtocolInstance );
};
...
public:
    HistoryNewRoundMessage( bin_consensus_round _r, bin_consensus_value _value,
        BinConsensusInstance& _srcProtocolInstance );
};
