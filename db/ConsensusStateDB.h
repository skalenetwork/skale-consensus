...
class ConsensusStateDB : public CacheLevelDB {
    ...
    string createBinValueKey( block_id _blockId, schain_index _proposerIndex,
...
public:
    ...
    void writePr( block_id _blockId, schain_index _proposerIndex, bin_consensus_round _r,
        bin_consensus_value _v );

    void writeBVBVote( block_id _blockId, schain_index _proposerIndex, bin_consensus_round _r,
        schain_index _voterIndex, bin_consensus_value _v );

    void writeAUXVote( block_id _blockId, schain_index _proposerIndex, bin_consensus_round _r,
        schain_index _voterIndex, bin_consensus_value _v, const string& _sigShare );
    ...
    ptr< map< bin_consensus_round, set< bin_consensus_value > > > readBinValues(
        block_id _blockId, schain_index _proposerIndex );

    ptr< map< bin_consensus_round, bin_consensus_value > > readPRs(
        block_id _blockId, schain_index _proposerIndex );
};
